            ...
            <ul className="nav navbar-nav flex-row">
                <li className="nav-item"><a className="navbar-brand" href="../../../html/ltr/horizontal-menu-template/index.html">
                        <div className="brand-logo">
                            <img className="logo" src={"static/frontend/app-assets/images/logo/logo-light.png"} />
                        </div>
 ...
 */}                                    <ul className="search-list"></ul>
                    ...
                    <ul className="nav navbar-nav float-right d-flex align-items-center">
                                ...
                                <li className="scrollable-container media-list"><a className="d-flex justify-content-between" href="javascript:void(0)">
                                        <div className="media d-flex align-items-center">
                                            <div className="media-left pr-0">
                                                <div className="avatar mr-1 m-0"><img src={"static/frontend/app-assets/images/portrait/small/avatar-s-11.jpg"} alt="avatar" height="39" width="39"/></div>
                                            </div>
                                    ...
                                    <div className="d-flex justify-content-between cursor-pointer">
                                        <div className="media d-flex align-items-center py-0">
                                            <div className="media-left pr-0"><img className="mr-1" src= {"static/frontend/app-assets/images/icon/sketch-mac-icon.png"}  alt="avatar" height="39" width="39"/></div>
                                            <div className="media-body">
                        ...
                        <li className="dropdown dropdown-user nav-item"><a className="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                                <div className="user-nav d-lg-flex d-none"><span className="user-name">John Doe</span><span className="user-status">Available</span></div><span><img className="round" src={"static/frontend/app-assets/images/portrait/small/avatar-s-11.jpg"} alt="avatar" height="40" width="40"/></span>
                            </a>
